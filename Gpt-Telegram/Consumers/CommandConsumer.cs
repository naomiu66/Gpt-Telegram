...
namespace Gpt_Telegram.Consumers
{
    public class CommandConsumer : BackgroundService
    {
        ...
        public CommandConsumer(IServiceScopeFactory scopeFactory, IRabbitMqConnection connection)
        {
        ...
        protected override async Task ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            await channel.QueueDeclareAsync(queue: "commands",
                durable: true,
                exclusive: false,
                autoDelete: false,
                arguments: null);
            ...
            consumer.ReceivedAsync += async (model, ea) =>
            {
                ...
                try
                {
                    ...
                    try
                    {
                        await commandHandler.HandleAsync(update, cts.Token);
                    }
                    finally
                    {
                        cts.Dispose();
            ...
            await channel.BasicConsumeAsync(queue: "commands",
                autoAck: false,
                consumer: consumer);
        }
    }
